 ...
 * Author: Siddharth
 * Date: 2024-12-22
 * Description: _lcp[i] : lcp b/w i and i + 1 th index
 * lcp(i,j) lcp b/w i and j th index
 * p[i] : start index corresponding to i th lex-smallest suffix
 * c[i] : # in lex arrangement for suffix starting at i
 */
